...
import { Phone, Mail, Calendar, Share2, Facebook, Instagram, ExternalLink, ArrowRight, Info, User } from 'lucide-react';
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-10 px-4 sm:px-6">
      ...
      <div className="max-w-md mx-auto mb-4">
        <Link href="/" className="inline-flex items-center gap-1 text-indigo-600 font-medium hover:text-indigo-800 transition-colors">
          <ArrowRight className="h-4 w-4" />
          <span>חזרה לגרסה הרגילה</span>
        </Link>
      </div>
            ...
            {activeTab === 'contact' && (
              ...
              >
                <p className="text-center text-gray-600 mb-6">
                  מציאת הבית המושלם עבורך היא המשימה שלי
                </p>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="flex flex-col items-center gap-2 p-5 rounded-2xl bg-gradient-to-r from-gray-50 to-gray-100 shadow-sm hover:shadow-md transition-shadow col-span-2"
                  >
